        ...
        <div className="container mx-auto max-w-6xl">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
            <div className="text-center">
              ...
              <h3 className="text-2xl font-semibold mb-4">{t("about.coreValues.precision.title")}</h3>
              <p className="text-lg text-muted-foreground leading-relaxed">
                {t("about.coreValues.precision.description")}
              </p>
            </div>
            ...
            <div className="text-center">
              ...
              <h3 className="text-2xl font-semibold mb-4">{t("about.coreValues.efficiency.title")}</h3>
              <p className="text-lg text-muted-foreground leading-relaxed">
                {t("about.coreValues.efficiency.description")}
              </p>
            </div>
            ...
            <div className="text-center">
              ...
              <h3 className="text-2xl font-semibold mb-4">{t("about.coreValues.care.title")}</h3>
              <p className="text-lg text-muted-foreground leading-relaxed">
                {t("about.coreValues.care.description")}
              </p>
            </div>
          </div>
        </div>
